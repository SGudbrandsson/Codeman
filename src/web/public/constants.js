...
const SSE_EVENTS = {
  ...
  ORCHESTRATOR_MERGE_PREP_STARTED: 'orchestrator:mergePrepStarted',
  ORCHESTRATOR_MERGE_PREP_COMPLETED: 'orchestrator:mergePrepCompleted',
  ORCHESTRATOR_COMPLETION: 'orchestrator:completion',
